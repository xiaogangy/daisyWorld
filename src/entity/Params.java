...
public class Params {
	...
	public static final double NUM_WHITES = 0.15;
	public static final double NUM_BLACKS = 0.15;
	public static final double NUM_GRAY = 0.15;
	...
	// Changing this figure when doing the different experiments
